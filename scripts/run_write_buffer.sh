    ...
    do
      ...
      do
        ...
        do
          ...
          mkdir -p results/direct_io_${direct_io}/write_buffer_${write_buffer_size}
          for comp in 3
          do
            ...
            echo "stdbuf -oL sudo ./microbenchmarks/run_ssddup \
              ...
              | tee results/direct_io_${direct_io}/write_buffer_${write_buffer_size}/compressibility_${comp}-content_${content_distribution}_${content_skewness}-access_pattern_${access_pattern_distribution}_${access_pattern_skewness}-num_chunks_${num_chunks}-num_requests_${num_requests}-ca_bits_${ca_bits}
            stdbuf -oL sudo ./microbenchmarks/run_ssddup \
              --lba-bits 11 --ca-bits $ca_bits --multi-thread ${multithread} --num-workers ${num_workers} --direct-io ${direct_io} --write-buffer-size ${write_buffer_size} \
              --trace ../trace/compressibility_${comp}/${content_distribution}_${content_skewness}-chunk_size_${chunk_size}-num_unique_chunks_${num_unique_chunks}-num_chunks_${num_chunks} \
              --access-pattern ../trace/access_pattern/${access_pattern_distribution}_${access_pattern_skewness}-num_chunks_${num_chunks}-num_requests_${num_requests} \
              | tee -a results/direct_io_${direct_io}/write_buffer_${write_buffer_size}/compressibility_${comp}-content_${content_distribution}_${content_skewness}-access_pattern_${access_pattern_distribution}_${access_pattern_skewness}-num_chunks_${num_chunks}-num_requests_${num_requests}-ca_bits_${ca_bits}
          done
        done
      done
    done
      ...
      do
        ...
        do
          ...
          echo "stdbuf -oL sudo ./microbenchmarks/run_ssddup \
            ...
            | tee results/direct_io_${direct_io}/write_buffer_${write_buffer_size}/compressibility_${comp}-content_${content_distribution}_${content_skewness}-access_pattern_${access_pattern_distribution}-num_chunks_${num_chunks}-num_requests_${num_requests}-ca_bits_${ca_bits}
          stdbuf -oL sudo ./microbenchmarks/run_ssddup \
            --lba-bits 11 --ca-bits $ca_bits --multi-thread ${multithread} --num-workers ${num_workers} --direct-io ${direct_io} --write-buffer-size ${write_buffer_size} \
            --trace ../trace/compressibility_${comp}/${content_distribution}_${content_skewness}-chunk_size_${chunk_size}-num_unique_chunks_${num_unique_chunks}-num_chunks_${num_chunks} \
            --access-pattern ../trace/access_pattern/${access_pattern_distribution}-num_chunks_${num_chunks}-num_requests_${num_requests} \
            | tee -a results/direct_io_${direct_io}/write_buffer_${write_buffer_size}/compressibility_${comp}-content_${content_distribution}_${content_skewness}-access_pattern_${access_pattern_distribution}-num_chunks_${num_chunks}-num_requests_${num_requests}-ca_bits_${ca_bits}
        done
      done
    done
  done
